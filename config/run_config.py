...
step2_train, step3_eval, step4_predict 가 모두 이 파일의 RUN_MODELS 를 참조
...
# 아래 경로로 복사하기 때문에, 폴더 이름이 늘어나도 최종파일로 사용함
WEIGHTS = {
...
# ---- 실행 전 확인 ----
# CONFIRM_RUN True 로 바꾸면 만들어질 폴더명을 입력란에 띄우고 확인까지 받는다.
